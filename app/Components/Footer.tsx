...
export const Footer: React.FC<FooterProps> = ({ onOpenSchedule }) => {
  return (
    <footer className="relative text-[#292524] pt-14 pb-12 px-6 sm:px-12 lg:px-16 overflow-hidden shadow-[0_-1px_3px_0_rgba(0,0,0,0.06)]">
      <div className="max-w-7xl mx-auto space-y-10 relative z-10">
        {/* Top Header Row: Brand Title + Social Media */}
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
          <div className="text-[14vw] sm:text-[120px] lg:text-[180px] font-extrabold tracking-tighter text-[#ded5c4] leading-none text-center opacity-85 font-sans pointer-events-none">
            Standup
          </div>
